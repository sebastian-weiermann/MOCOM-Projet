...
# Start SUMO with configuration (using actuated network file)
...
collector = KpiCollector(
    ...
    stop_speed=0.1,
    emissions_file="emissions_actuated.xml",
)

# Run simulation for 3600 steps using actuated traffic lights (from network file)
step = 0
...
collector.save_kpis("kpis_actuated.json")
print("Saved KPIs to kpis_actuated.json")
